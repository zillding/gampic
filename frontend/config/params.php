...
return CMap::mergeArray(
	...
	CMap::mergeArray(
		array(
			'originalImagePath' => dirname(dirname(__FILE__)).'/www/files/upload/orig',
			'thumbnailImagePath' => dirname(dirname(__FILE__)).'/www/files/upload/thumb',
			'originalImageDir' => '/files/upload/orig',
			'thumbnailImageDir' => '/files/upload/thumb',
			'url.rules' => array(
